...
export default function TrackShipmentPage() {
  ...
  const getCarrierLogo = (carrierName: string) => {
    if (carrierName === "GIG Logistics" || carrierName === "DHL Express") {
      return logoImage;
    }
    return carrierName;
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {trackingData && (
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              {/* Carrier Information - FIXED: Replaced <img> with Next.js Image */}
                  ...
                  <div className="flex items-center space-x-4">
                    {trackingData.data.carrier.logo && (
                      <div className="h-12 w-12 relative flex-shrink-0">
                        {getCarrierLogo(trackingData.data.carrier.name) === logoImage ? (
                          <Image
                            src={logoImage}
                          ...
                          <div className="relative h-12 w-12">
                            <Image
                              src={trackingData.data.carrier.logo}
                              alt={trackingData.data.carrier.name}
                              width={48}
                              height={48}
                              className="object-contain"
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">
                        {trackingData.data.carrier.name === "GIG Logistics" 
                          ? "Obana Express (Local)" 
                          : trackingData.data.carrier.name === "DHL Express" 
                          ? "Obana Express (International)" 
                          : trackingData.data.carrier.name || 'Not specified'}
                      </p>
                      <div className="flex space-x-4 mt-1">
                        <p className="text-sm text-gray-600">📞 {trackingData.data.carrier.contact.phone}</p>
                        <p className="text-sm text-gray-600">✉️ {
                          trackingData.data.carrier.contact.email === "info@giglogistics.com" 
                            ? "obana.africa@gmail.com" 
                            : trackingData.data.carrier.name === "DHL Express" 
                            ? "obana.africa@gmail.com" 
                            : trackingData.data.carrier.contact.email
                        }</p>
                      </div>
                    </div>
                  </div>
...
// Include all your interfaces here (copy them exactly as they were)
