// logistics-partners.tsx - Simplified for Direct Terminal Africa
...
const LogisticsPartners: React.FC<LogisticsPartnersProps> = ({
  ...
  const handleContinue = () => {
    const selectedRate = availableRates.find((r) => r.rate_id === selectedRateId);
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="mt-4 text-gray-600">Please wait while we find the best rates for you</p>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <p className="text-gray-600 text-center mb-6">
            We couldn't find any carriers for this route. Please try a different route or contact support.
          </p>
          <Button
            onClick={onBack}
            variant="outline"
  ...
  return (
    <div className="space-y-6">
      ...
      <RadioGroup value={selectedRateId} onChange={setSelectedRateId}>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col flex-grow">
                  <div className="flex items-center gap-2 mb-2">
                    {selectedRateId === rate.rate_id ? (
                      <MdRadioButtonChecked className="text-blue-600 size-5 flex-shrink-0" />
                    ) : (
                      <MdRadioButtonUnchecked className="text-gray-400 size-5 flex-shrink-0" />
                    )}
                  ...
                  <div className="space-y-1 flex-grow">
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="font-medium text-sm">{rate.carrier_rate_description}</p>
                    </div>
                  </div>
                </div>
              </div>
