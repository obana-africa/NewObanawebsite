...
const JourneyStep: React.FC<{
  ...
  return (
    <div
      ...
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
      className="flex flex-col items-center text-center lg:flex-row lg:items-start lg:text-left gap-4 transition-all duration-500 ease-out"
      style={{
        transform: isInView ? "translateX(0)" : "translateX(-20px)",
        opacity: isInView ? 1 : 0,
        transitionDelay: isInView ? `${index * 100}ms` : "0ms",
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .why-orb { animation: softPulseWhy 8s ease-in-out infinite; }
      ` }} />
      ...
      >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            {/* RIGHT COLUMN — WHY US — first on mobile via order */}
            <div className="order-1 lg:order-2 flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed max-w-[500px] lg:max-w-none mx-auto lg:mx-0">
                Designed around how fashion & beauty SMEs actually work —
                informal, fast-moving, relationship-driven — with the digital
                tools to match.
              </p>
              ...
              {/* Stats grid */}
              <div className="hidden md:grid grid-cols-2 gap-5 mb-8 w-full">
                {STATS_DATA.map((stat, idx) => (
                  <div
                    key={idx}
                    className="rounded-xl p-4 transition-all duration-300 hover:translate-y-[-2px]"
            ...
            {/* LEFT COLUMN — SME JOURNEY — second on mobile */}
            <div className="order-2 lg:order-1 lg:max-w-md flex flex-col items-center text-center lg:items-start lg:text-left">
              <div className="mb-8">
                <span className="text-lg font-bold uppercase tracking-wider text-[#F9C319]">
                  THE SME JOURNEY
                </span>
