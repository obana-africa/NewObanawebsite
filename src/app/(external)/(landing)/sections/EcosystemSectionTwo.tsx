      ...
      <div className="mx-auto max-w-[1271px] px-4 md:px-0 relative" style={{ zIndex: 10 }}>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:h-full gap-8 md:gap-[30px]">
            ...
            <div className="w-full md:w-[492px] flex flex-col items-center md:items-start justify-center gap-8 md:gap-[41px] text-center md:text-left">
              <div>
                <h2
                ...
                <p className="text-base md:text-lg text-white/80 leading-relaxed mx-auto md:mx-0 max-w-[420px] md:max-w-none">
