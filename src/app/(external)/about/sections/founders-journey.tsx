					...
					<div className="w-full md:w-3/5">
						...
						<div className="mt-4 md:mt-6 space-y-4 md:space-y-8 text-[#222] md:text-base lg:text-md leading-6">
							<p data-aos="fade-right">
								In 2012, our founder began his journey as a pioneering team member at{" "}
								...
								gave him deep insights into the challenges and opportunities
							...
							<p data-aos="fade-left">
								...
								first-party retail model to a third-party retail marketplace. 
								It was during this transition that he identified a major gap in 
								the market: local vendors needed to source products internationally 
								in order to sell on online platforms locally.
							</p>

							<p data-aos="fade-right">
								By 2015, he co-founded{" "}
								<span className="font-bold">Fazsion.ng</span> alongside Bo Hansen 
								from Denmark. The platform was initially envisioned as a cross-border 
								retail e-commerce platform. However, based on the market gap he had 
								observed during his time at Konga, the business pivoted to a B2B 
								wholesale model in order to better serve local vendors.
							</p>
						</div>
					</div>
						...
						<div className="mt-4 md:mt-6 space-y-4 md:space-y-8 text-[#222] md:text-base lg:text-md leading-6">
							<p data-aos="fade-up">
								...
								<span className="font-bold">
									annual revenue of ₦500 million NGN.
								</span>
								This achievement solidified the need for an efficient, 
								well-structured B2B marketplace that would empower local businesses.
							</p>

							<p data-aos="fade-up">
								Fast forward to 2024, and he was part of the team that founded{" "}
								<span className="font-bold">Trade Enablers</span>, a company
								providing e-commerce as a service for B2B and B2C transactions.
								The company works in partnership with Nigerian banks to drive 
								digital commerce across the country.
							</p>

							<p data-aos="fade-up">
								Later in 2024, he took a bold step forward by founding
								<span className="font-bold"> Obana.Africa</span>, an innovative
								platform designed to expand the scope of B2B offerings for
								local SMEs. Obana goes beyond importation from China and the United States,
								instead focusing on exposing Sub-Saharan African SMEs to regional trade
								opportunities within a <span className="font-bold">$300 billion USD market</span>. 
								The vision for Obana is to operate as an ecosystem, integrating key partners 
								that SMEs need in order to scale, offering them an all-in-one platform for
							...
							<p data-aos="fade-up">
								...
								for SMEs across the African continent.
							</p>
						</div>
					</div>
